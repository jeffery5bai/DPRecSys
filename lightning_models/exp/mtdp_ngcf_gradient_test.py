...
class MTDPRecSRM_G(NGCFRec):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log_dict({"train_dps_loss": self.mt_weights["dps_loss"] * dps_loss}, on_step=True) # on_epoch=True,
        ...
        self.log_dict({"train_dpr_loss": self.mt_weights["dpr_loss"] * dpr_loss}, on_step=True) # on_epoch=True,
        ...
        self.log_dict({"train_dpm_loss": self.mt_weights["dpm_loss"] * dpm_loss}, on_step=True) # on_epoch=True,
