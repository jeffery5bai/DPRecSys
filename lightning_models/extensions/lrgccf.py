...
from modules.lrgccf_modules import LRGCCF
from pytorch_lightning import LightningModule


class LRGCCFRec(LightningModule):
    """
    Wrap up `LRGCCF` model into Lightning Module as base recommendation model.
    """
    ...
    def training_step(self, batch, batch_idx):
        user_emb, item_emb = self.lrgccf_model()  # Compute embedding for training
    ...
    def on_validation_epoch_start(self):
        self.user_emb, self.item_emb = self.lrgccf_model()  # Compute embedding once for val phase
    ...
    def on_test_epoch_start(self):
        self.user_emb, self.item_emb = self.lrgccf_model()
